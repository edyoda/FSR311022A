...
var userNames = ["John", "Alex", "Jack", "Peter", "Undertaker", "Benedict A"];
console.log(userNames);
var serchedWord = "k";

function onArrayFilter(item) {
  var includes = item.toLowerCase().includes(serchedWord.toLowerCase());
  return includes;
  // return true if you want item to be considered
  // return false if you don't want item to be considered
}

var filteredArray = userNames.filter(onArrayFilter);
...
// ToDo List : https://res.cloudinary.com/practicaldev/image/fetch/s--HS8bkkIb--/c_imagga_scale,f_auto,fl_progressive,h_900,q_auto,w_1600/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/kh657gzuo9flabph0y4a.jpg
